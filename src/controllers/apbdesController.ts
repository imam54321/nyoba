...
export const getAPBDes = async (req: Request, res: Response) => {
  try {
...
export const getAPBDesById = async (req: Request, res: Response) => {
  try {
...
export const createAPBDes = async (req: Request, res: Response) => {
  try {
    const {
      pemasukan,
      pengeluaran,
...
export const updateAPBDes = async (req: Request, res: Response) => {
  try {
    const id = BigInt(String(req.params.id));
...
export const deleteAPBDes = async (req: Request, res: Response) => {
  try {
    const id = BigInt(String(req.params.id));
